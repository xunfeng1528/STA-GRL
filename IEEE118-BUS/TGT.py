...
class STConv(nn.Module):
    def __init__(
        ...
        self.bias = bias
        self.fc = nn.Linear(26432, self.out_channels * 1024)
        self.fc4 = nn.Linear(1024, 54*6)
        ...
        self.gcn = GCN(6, hidden_channels, hidden_channels)
    ...
    def forward(
        ...
        x_yuanshi=data.x,
        X = data.x.reshape(-1, 6, self.num_nodes, self.in_channels)
        edge_weight = None
