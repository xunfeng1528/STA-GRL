...
STConv_net = STConv(30, 1, 128, 1, 3, 10)
...
best_model = STConv(30, 1, 128, 1, 3, 10).to(device)
...
results_df.to_csv('result_plot.csv', index=False, float_format='%.6f')
...
test_df.to_csv('test_predictions_plot.csv', index=False, float_format='%.6f')
